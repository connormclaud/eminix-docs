...
import { Terminal, Play, BookOpen, Code2, BarChart3, ArrowLeft } from 'lucide-react';
...
export default function GapBufferPage() {
  ...
  return (
    <div className="min-h-screen text-text-primary">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4">
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-sm text-text-secondary hover:text-text-primary transition-colors mb-4 group"
        >
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 pb-8 text-center">
